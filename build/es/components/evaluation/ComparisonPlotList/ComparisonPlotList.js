...
export const ComparisonPlotList = ({ evaluationPerOrgUnits, useVirtuoso = true, useVirtuosoWindowScroll = false, }) => {
    ...
    return (React.createElement("div", null,
        React.createElement(Virtuoso, { style: { height: '60vh' }, useWindowScroll: useVirtuosoWindowScroll, totalCount: evaluationPerOrgUnits.length, itemContent: getItemContent() })));
};
