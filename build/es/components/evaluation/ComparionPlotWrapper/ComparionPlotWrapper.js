...
export const ComparionPlotWrapper = ({ evaluations, splitPeriods, }) => {
        ...
        React.createElement("div", { className: styles.wrapper },
            React.createElement("div", { className: styles.filter },
                ...
                React.createElement("div", null,
                    ...
                    allOrgUnits.map((orgUnit, i) => (React.createElement(Checkbox, { checked: selectedOrgUnits.filter((o) => o == orgUnit.id).length > 0, onChange: onChangeOrgUnitSelected, label: orgUnit.name, key: orgUnit.id, value: orgUnit.id }))))),
