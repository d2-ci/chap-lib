    ...
    return orgUnits ? (React.createElement("div", null,
        ...
        React.createElement("div", { className: styles.predictionMapGroup }, periods.map((period, index) => {
            return (React.createElement("div", { className: styles.predictionMapCard, key: index },
                React.createElement("h4", null, i18n.t(createFixedPeriodFromPeriodId({
                    periodId: period,
                    calendar: 'gregory',
                }).displayName)),
        ...
        React.createElement(Legend, { title: i18n.t('Median Prediction for {{predictionTargetName}}', {
                predictionTargetName,
            }), bins: bins, colors: colors }))) : null;
};
